...
@interface SecondDayWorkoutPlanManager()
// Database object
...
@implementation SecondDayWorkoutPlanManager
...
+ (SecondDayWorkoutPlanManager *)sharedInstance {
	static SecondDayWorkoutPlanManager *globalInstance;
