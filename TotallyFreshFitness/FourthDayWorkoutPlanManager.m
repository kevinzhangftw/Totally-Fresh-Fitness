...
@interface FourthDayWorkoutPlanManager()
...
@implementation FourthDayWorkoutPlanManager

/*
 Singleton FourthDayWorkoutPlanManager object
 */
+ (FourthDayWorkoutPlanManager *)sharedInstance {
	static FourthDayWorkoutPlanManager *globalInstance;
