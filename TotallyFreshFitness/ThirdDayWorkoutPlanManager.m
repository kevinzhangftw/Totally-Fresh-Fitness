...
@interface ThirdDayWorkoutPlanManager()
// Database object
...
@implementation ThirdDayWorkoutPlanManager
...
+ (ThirdDayWorkoutPlanManager *)sharedInstance {
	static ThirdDayWorkoutPlanManager *globalInstance;
